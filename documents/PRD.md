...
**One-liner:** *The VS Code of genealogy — lightweight, beautiful, and infinitely extensible.*
...
> [!NOTE]
> The initial build is for personal/family use. The architecture should be clean enough that it *could* serve a broader audience later, but we're not optimising for that now.
...
This section explains *what* each technology is and *why* it was chosen. If you're not a developer, focus on the "Why it matters" column — that's the user-facing impact.
...
*This document is a living artifact. Update it as development progresses and priorities evolve.*
